...
import org.hornetq.javaee.example.ServletTransportExample;
...
public class ServletTransportRunnerTest
{
   //@Deployment(name = "servlet", order = 1)
   public static Archive<?> deployServlet()
   {
      WebArchive war = ShrinkWrap.create(WebArchive.class, "servlet-transport-example.war");
      war.addAsWebInfResource(ServletTransportRunnerTest.class.getPackage(), "/web.xml", "/web.xml");
   ...
   public static Archive getDeployment()
   {
      ...
      ear.addAsManifestResource(ServletTransportRunnerTest.class.getPackage(), "application.xml", "application.xml");
   ...
   {
      ServletTransportExample.main(null);
   }
