...
public class TypedPropertiesConversionTest extends Assert
{
   ...
   public void testBooleanProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Boolean.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Boolean.toString(val)));
      Assert.assertEquals(val, props.getBooleanProperty(key));
   ...
   public void testCharProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Character.toString(val)), props.getStringProperty(key));
   ...
   public void testByteProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Byte.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Byte.toString(val)));
      Assert.assertEquals(val, props.getByteProperty(key));
   ...
   public void testIntProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Integer.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Integer.toString(val)));
      Assert.assertEquals(val, props.getIntProperty(key));
   ...
   public void testLongProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Long.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Long.toString(val)));
      Assert.assertEquals(val, props.getLongProperty(key));
   ...
   public void testDoubleProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Double.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Double.toString(val)));
      Assert.assertEquals(val, props.getDoubleProperty(key));
   ...
   public void testFloatProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Float.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Float.toString(val)));
      Assert.assertEquals(val, props.getFloatProperty(key));
   ...
   public void testShortProperty() throws Exception
   {
      ...
      Assert.assertEquals(new String(Short.toString(val)), props.getStringProperty(key));

      props.putStringProperty(key, new String(Short.toString(val)));
      Assert.assertEquals(val, props.getShortProperty(key));
   ...
   {
      String strVal = RandomUtil.randomString();
      props.putStringProperty(key, strVal);
      Assert.assertEquals(strVal, props.getStringProperty(key));
   }
