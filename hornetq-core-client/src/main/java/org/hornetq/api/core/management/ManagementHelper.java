...
public final class ManagementHelper
{
                                             ...
                                             final Object... parameters) throws Exception
   {
      ...
      message.getBodyBuffer().writeNullableSimpleString(paramString);
   }
   ...
   {
      String sstring = message.getBodyBuffer().readNullableSimpleString();
   ...
   public static void storeResult(final Message message, final Object result) throws Exception
   {
      ...
      message.getBodyBuffer().writeNullableSimpleString((resultString));
   }
