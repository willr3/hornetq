...
public class ClosingConnectionTest extends ServiceTestBase
{
   ...
   *
   * Note: HornetQ 2.4.x and beyond use Netty 4.x which doesn't suffer from this same problem as HornetQ 2.3.x which
   * uses Netty 3.6.x.  This test is added here just for good measure.
   */
   @Test
   @BMRules
      (
