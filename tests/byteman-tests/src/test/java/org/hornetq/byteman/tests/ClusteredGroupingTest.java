         ...
         rules =
            {
               @BMRule
                  (
                     name = "blow-up",
                     targetClass = "org.hornetq.core.server.group.impl.LocalGroupingHandler",
                     targetMethod = "removeGrouping",
                     targetLocation = "ENTRY",
                     action = "org.hornetq.byteman.tests.ClusteredGroupingTest.pause($1);"
                  ),
               @BMRule
                  (
                     name = "blow-up2",
                     targetClass = "org.hornetq.core.server.group.impl.GroupHandlingAbstract",
                     targetMethod = "forceRemove",
                     targetLocation = "ENTRY",
                     action = "org.hornetq.byteman.tests.ClusteredGroupingTest.restart2();"
                  )
            }
      )
         ...
         rules =
            {
               @BMRule
                  (
                     name = "blow-up",
                     targetClass = "org.hornetq.core.server.group.impl.RemoteGroupingHandler",
                     targetMethod = "onNotification",
                     targetLocation = "ENTRY",
                     action = "org.hornetq.byteman.tests.ClusteredGroupingTest.pause2($1);"
                  ),
