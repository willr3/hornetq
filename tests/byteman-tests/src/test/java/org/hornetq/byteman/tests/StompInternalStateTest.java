         ...
         rules =
            {
               @BMRule
                  (
                     ...
                     targetClass = "org.hornetq.core.protocol.stomp.StompProtocolManager",
                     targetMethod = "onNotification(org.hornetq.core.server.management.Notification)",
                     targetLocation = "EXIT",
                     helper = "org.hornetq.byteman.tests.StompInternalStateTest",
