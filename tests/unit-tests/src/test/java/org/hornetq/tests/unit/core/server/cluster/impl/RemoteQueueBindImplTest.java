...
public class RemoteQueueBindImplTest extends UnitTestCase
{
   ...
   public void testAddRemoveConsumer() throws Exception
   {
      ...
      final String address = RandomUtil.randomString();
      final String uniqueName = RandomUtil.randomString();
      final String routingName = RandomUtil.randomString();
      ...
      final String bridgeName = RandomUtil.randomString();
