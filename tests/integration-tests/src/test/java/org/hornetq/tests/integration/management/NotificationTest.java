...
public class NotificationTest extends UnitTestCase
{
   ...
   public void testCONSUMER_CREATED() throws Exception
   {
      ...
      Assert.assertEquals(("myUser"), notifications[0].getSimpleStringProperty(ManagementHelper.HDR_USER));
      Assert.assertEquals(("invm:0"), notifications[0].getSimpleStringProperty(ManagementHelper.HDR_REMOTE_ADDRESS));
