...
public class ExpiryAddressTest extends ServiceTestBase
{
   ...
   public void testExpireWithOverridenSublevelAddressSettings() throws Exception
   {
      ...
      String defaultExpiryAddress = RandomUtil.randomString();
      String defaultExpiryQueue = RandomUtil.randomString();
      String specificExpiryAddress = RandomUtil.randomString();
      String specificExpiryQueue = RandomUtil.randomString();
